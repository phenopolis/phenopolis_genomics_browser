      ...
      return (
        <React.Fragment>
          ...
          <div className={classes.root}>
            <MetaData
              metadata={this.state.geneInfo.metadata}
              name={
                this.state.geneInfo.metadata.data[0].gene_name +
                ' - ' +
                this.state.geneInfo.metadata.data[0].full_gene_name
              }
            />
            ...
            <Container maxWidth="xl">
              ...
              <VirtualGrid
                tableData={this.state.geneInfo.variants}
...
export default compose(withStyles(styles), withTranslation(), connect(null, { setSnack }))(Gene);
