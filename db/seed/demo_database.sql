...
-- Load Demo DATA
\copy public.users FROM 'db/seed/users.csv' delimiter ';' CSV HEADER;
\copy public.variants FROM 'db/seed/variants.csv' delimiter ',' CSV HEADER;
\copy public.het_variants FROM 'db/seed/het_variants.csv' delimiter ',' CSV HEADER;
\copy public.hom_variants FROM 'db/seed/hom_variants.csv' delimiter ',' CSV HEADER;
\copy public.genes FROM 'db/seed/genes.csv' delimiter ',' CSV HEADER;
\copy public.individuals FROM 'db/seed/individuals.csv' delimiter ',' CSV HEADER;
\copy public.hpo FROM 'db/seed/hpo.csv' delimiter ',' CSV HEADER;
\copy public.users_individuals FROM 'db/seed/users_individuals.csv' delimiter ',' CSV HEADER;
\copy public.user_config FROM 'db/seed/user_configs.csv' delimiter ',' CSV HEADER;
